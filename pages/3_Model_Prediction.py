    ...
    if input_method == "Manual Input":
        ...
        if st.button("Make Prediction"):
            try:
                ...
                input_processed = model.preprocess_data(input_df)

                # Make prediction
                prediction = model.model.predict(model.scaler.transform(input_processed))
                prediction_proba = model.model.predict_proba(model.scaler.transform(input_processed))
        ...
        if uploaded_file:
            try:
                ...
                if st.button("Make Predictions"):
                    ...
                    # Make predictions
                    predictions = model.model.predict(model.scaler.transform(input_processed))
                    predictions_proba = model.model.predict_proba(model.scaler.transform(input_processed))
